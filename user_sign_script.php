<?php
	...
	$email=mysqli_real_escape_string($con,$_POST['email']);
			 ...
			 $aaa="select email from user_signup where email='$email'";
	...
	$user_signup_query="insert into user_signup(name,email,password,contact,city,address) values('$name','$email','$password',$contact,'$city','$address')";
